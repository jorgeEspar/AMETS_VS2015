...
function InitLeftMenu()
{
    ...
    $('#menuGeneracionFacturasOld').attr('href', 'FacturaOld.aspx?id=&N=S&B=N'); // Facturas
    $('#menuGeneracionFacturas2').attr('href', 'MtoFactura.aspx?id=&N=S&B=N'); // Facturas
    $('#menuGeneracionFacturasX').attr('href', 'FacturasX.aspx?id=&N=S&B=N'); // Facturas

    //Pagos
    $('#menuListadoPagos').attr('href', 'pagos_listado.aspx'); // Pagos Listado
    $('#menuMtoPagos').attr('href', 'Pago.aspx?id=&N=S&B=N');  // Pagos

    //Precios
    $('#menuListadoPrecios').attr('href', 'precios_listado.aspx'); // Precios Listado
    $('#menuMtoPrecios').attr('href', 'Precio.aspx?id=&N=S&B=N');  // Precios
