<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Preporte.aspx.vb" Inherits="TransAmets2.Preporte" %>
    ...
    <div class="container Multiopcion">
        <div class="row" style="margin-top: 0px !important; margin-bottom: 15px !important">
            <div class="col-md-4 col-sm-4 text-left pd-l-0">
                <h1><label id="lblTituloPag" runat="server">NUEVO PREPORTE</label></h1>
            </div>
            <div class="col-md-2 col-sm-2 text-center" style="margin-top: 20px;">
                
            </div>
            <div class="col-md-6 col-sm-6 pd-r-0" style="margin-top: 0px;">
                <div style="float:right;">
                    <div class="row registro">
                        <div class="col-md-6 col-sm-6 col-xs-6 form-group">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" style="width: 135px;text-align: left;"><i class="fa fa-calendar"></i> Fecha Alta</span>
                                    <asp:TextBox ID="txtFecha" runat="server" CssClass="form-control date-picker hasDatepicker"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 form-group pd-l-0">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" style="width: 135px;text-align: left;"><i class="fa fa-calendar"></i> Fecha Porte</span>
                                    <asp:TextBox ID="txtFecPorte" runat="server" CssClass="form-control date-picker hasDatepicker"></asp:TextBox>
                                </div>
                            </div>
                        </div>                     
                    </div>
                    <div class="row registro" style="margin-top: 0px;">
                        <div class="col-md-6 col-sm-6 col-xs-6 form-group">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" style="width: 135px;text-align: left;"><i class="fa fa-calendar"></i> Fecha Compra</span>
                                    <asp:TextBox ID="txtFecCompra" runat="server" CssClass="form-control date-picker hasDatepicker"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 form-group pd-l-0">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" style="width: 135px;text-align: left;"><i class="fa fa-calendar"></i> Fecha Entrega</span>
            ...
            <div class="pestanas col-md-12 col-sm-12 pd-l-0 pd-r-0">
                ...
                <div id="pestanas" style="float: left; position: absolute; top: 0; z-index: 0;">
                    ...
                    <ul id="tabs" class="nav nav-tabs"  data-tabs="tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#TabDatosPorte" aria-controls="future" role="tab" data-toggle="tab" data-tab="1">Datos Preporte</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="registro" style="padding-top: 10px">
                                <div class="row registro" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 pd-l-5 pd-r-5">
                                        <div class="col-md-4 col-sm-4 pd-l-5 pd-r-5 form-group">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-euro-sign"></i> COMPRA</span>
                                                    <input class="string NumericField form-control" id="txtCompra" type="text" runat="server" maxlength="8" />
                                                    <span class="input-group-addon">
                                                        <input type="checkbox" id="chkCompraAcordada" runat="server" data-toggle="tooltip" data-placement="bottom" tiitle="Compra acordada" />
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 pd-l-5 pd-r-5 form-group">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-euro-sign"></i> VENTA</span>
                                                    <input class="string NumericField form-control" id="txtVenta" type="text" runat="server" maxlength="8" />
                                                    <span class="input-group-addon">
                                                        <input type="checkbox" id="chkVentaAcordada" runat="server" data-toggle="tooltip" data-placement="bottom" tiitle="Venta acordada" />
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel panel-default" style="width: 100%">
                                        ...
                                        <div class="panel-body" style="display: inline-block; width: 100%; background-color: #fff;">
                                            <asp:UpdatePanel runat="server" ID="UP_Cliente" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                <div class="row registro">
                                                    <div class="col-md-5 col-sm-5 col-xs-5 pd-l-5 pd-r-5">
                                                        <div class="row col-md-12 col-sm-12 col-xs-12 form-group pd-l-0 pd-r-0">
                                                        ...
                                                        <div class="row col-md-12 col-sm-12 pd-l-0 pd-r-0 pd-t-10 form-group">
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">ORIGEN</span>
                                                                    <asp:DropDownList runat="server" ID="ddlOrigen" CssClass="form-control selectpicker show-tick" data-width="auto">
                                                                        <asp:ListItem Selected="True" Value="" Text="Seleccionar"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row col-md-12 col-sm-12 col-xs-12 pd-l-0 pd-r-0" style="margin-top: 35px">
                                                            <Label class="txtCliente"><i class="fa fa-map-marker-alt"></i> Dirección Origen libre</Label>
                                                    ...
                                                    <div id="dirCargaCliente" class="col-md-7 col-sm-7 col-xs-7" style="height: 268px !important; margin-top:15px;">
                                                        <div class="panel panel-default" style="height: 100%;">
                                                            <div class="panel-heading">
                                                                <table border="0" style="width: 100%;">
                                                                    <tr>
                                                                        <td style="width: 40px; margin-right: 15px;">
                                                                            <img class="boton_icono_sombra icono" id="btnAdd_DirCli" src="images/ico_button_add_grey.png" runat="server" title="Añadir Dirección carga Cliente" />
                                                                        </td>
                                                            ...
                                                            <div class="panel-body" style="display: inline-block; width: 100%; max-height: 240px; overflow-y: auto; background-color: #fff;">
                                ...
                                <div class="row registro">
                                    <div class="panel panel-default" style="width: 100%">
                                        ...
                                        <div class="panel-body" style="display: inline-block; width: 100%;background-color: #fff;">
                                            <!-- MATRICULA, AGENCIA -->
                                            <div class="row registro" style="padding-top: 10px !important;">
                                                <div class="col-md-6 col-sm-6 col-xs-6 pd-l-0 pd-r-0">
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="row registro" style="margin-top: 0px;">
                                                            <div class="col-md-7 col-sm-7 col-xs-7 form-group pd-l-0 pd-r-0">
                                                             ...
                                                             <div class="col-md-5 col-sm-5 col-xs-5 form-group pd-r-0">
                                                ...
                                                <div class="col-md-6 col-sm-6 form-group pd-l-0 pd-r-0">
                                                    <span><i class="fa fa-cube"></i> DETALLE Transportista</span>
                                                    <asp:TextBox ID="txtDetalleTrans" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="5"  placeholder="Indique el detalle del transportista ..." maxlength="1500"></asp:TextBox>
                                                    <span><label id="detalle_transportista"></label></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row registro">
                                    <div class="panel panel-default" style="width: 100%">
                                        ...
                                        <div class="panel-body" style="display: inline-block; width: 100%; max-height: 300px; background-color: #fff;">
                                            <div class="row" style="padding-top: 10px !important;">
                                                <div class="col-md-6 col-sm-6 pd-l-5 pd-r-5 form-group">
                                                    <div class="row col-md-12 col-sm-12 pd-l-0 pd-r-0">
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">DESTINO</span>
                                                                <asp:DropDownList runat="server" ID="ddlDestino" CssClass="form-control selectpicker show-tick" data-width="auto">
                                                                    <asp:ListItem Selected="True" Value="" Text="Seleccionar"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row col-md-12 col-sm-12 form-group" style="padding-top: 10px !important;">
                                                        <span><i class="fa fa-arrow-right"></i><i class="fa fa-map-marker-alt"></i> DESTINO PORTE</span>
                                                        <asp:TextBox ID="txtDestino" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="4" placeholder="Indique el destino del porte ..." maxlength="1500"></asp:TextBox>
                                                        <span><label id="destino_numcars"></label></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 form-group">
                                                    <span><i class="fas fa-info-circle"></i> DETALLE DESTINO PORTE</span>
                                                    <asp:TextBox ID="txtDetalleDestino" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="6" placeholder="Indique el detalle destino del porte ..." maxlength="1500"></asp:TextBox>
                                        ...
                                        <div class="panel-body" style="display: inline-block; width: 100%; background-color: #fff;">
                                            ...
                                            <div class="row registro pd-l-0 pd-r-0" style="padding-top: 10px !important;">
                                                <div class="col-md-6 col-sm-6 form-group">
                                                    ...
                                                    <asp:TextBox ID="txtDetalle" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="6"  placeholder="Indique el detalle del porte ..." maxlength="1500"></asp:TextBox>
                                            ...
                                            <div class="row registro pd-l-0 pd-r-0" style="padding-top: 10px !important;">
                                                <div class="col-md-6 col-sm-6 form-group">
                                                    ...
                                                    <asp:TextBox ID="txtObservaciones" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="6" placeholder="Indique las observaciones del porte ..." maxlength="1500"></asp:TextBox>
                        ...
                        <div role="tabpanel" class="tab-pane" id="TabSuplidos">
                            <div class="registro" style="padding-top: 10px;padding-bottom: 10px;">
                                <div class="row registro" style="margin-bottom: 10px;">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="form-group">
                                            <Label class="txtSuplidos"><i class="fas fa-clipboard-list"></i> Detalle suplido</Label>
                                    ...
                                    <div class="col-md-2 col-sm-2">
                                        <div class="form-group">
                                            <label for="lbl_Conductor"><i class="fa fa-euro-sign"></i> IMPORTE SUPLIDO</label>
                                            <div class="input-group">
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphScripts" runat="server">
    <script type="text/javascript">
        ...
        function Salir() {
            document.location.href = 'preportes_listado.aspx';
        }
        ...
        function ReloadDatepickers() {
            ...
            $('#ctl00_MainContent_txtFecha').daterangepicker({
                "autoUpdateInput": false,
                "showDropdowns": true,
                "autoApply": false,
                "singleDatePicker": true,
                ...
                $('#ctl00_MainContent_txtFecha').val(start.format('DD/MM/YYYY'));
            });
            /* Acciones de calendarios para reiniciar los input */
            $('.btn-cleantxtFecha').on('click', function () {
                $("#ctl00_MainContent_txtFecha").val('');
            });

            $('#ctl00_MainContent_txtFecCompra').daterangepicker({
                "autoUpdateInput": false,
                "showDropdowns": true,
                "autoApply": false,
                "singleDatePicker": true,
                ...
                $('#ctl00_MainContent_txtFecCompra').val(start.format('DD/MM/YYYY'));
            });
            /* Acciones de calendarios para reiniciar los input */
            $('.btn-cleantxtFecCompra').on('click', function () {
                $("#ctl00_MainContent_txtFecCompra").val('');
            });
        ...
        $('#ctl00_MainContent_txtDetalleTrans').keyup(function () {
            var obj = $('#ctl00_MainContent_txtDetalleTrans');
            Calcula_NumCars(obj, 'detalle_transportista', 1500)
        });
        ...
        function BuscardorPrecios() {
            var codcli = $("#ctl00_MainContent_txtCodCli").val();
            var codorigen = $("#ctl00_MainContent_ddlOrigen option:selected").val();
            var origen_libre = $("#ctl00_MainContent_txtDircargaLibre").val();
            var coddestino = $("#ctl00_MainContent_ddlDestino option:selected").val();
            var destino_libre = $("#ctl00_MainContent_txtDestino").val();
            var url = "precios_listado.aspx?codcli=" + codcli + "&co=" + codorigen + "&ol=" + origen_libre + "&cd=" + coddestino + "&dl=" + destino_libre;
            xx = window.open(url, "buscador_precios");
            xx.focus();
        }
        debugger;
    </script>
