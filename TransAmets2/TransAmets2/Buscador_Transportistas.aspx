<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Buscador_Transportistas.aspx.vb" Inherits="TransAmets2.Buscador_Transportistas" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="es">
    <head runat="server">
	    <title>BUSCADOR DE TRANSPORTISTAS</title>
		...
		<script type="text/javascript" language="javascript">
		    ...
		    function ReturnDataClient(Matricula, Propietario, Conductor) {
		        window.parent.TransportistaSelected(Matricula, Propietario, Conductor);
		    }
		    function pageLoad() {
        ...
        <style type="text/css">
            #txtMatricula, #txtPropietario, #txtConductor { text-transform: uppercase; }
            #CapaProgress
            {
                position:fixed;
                top:0px;
...
<body style="margin-top:-10px;">
	<form id="Form1" method="post" runat="server" defaultbutton="btSearch" style="width:98%" class="pd-l-0 pd-r-0">
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Always">
                        ...
                        <div id="dfiltros" class="row buscador gutter-10" style="margin-bottom: 10px !important;">
                            <div class="col-md-2 col-sm-2 form-group">
                                ...
                                <asp:TextBox ID="txtMatricula" runat="server" CssClass="form-control" Text="" MaxLength="15"></asp:TextBox>
                            </div>
                            <div class="col-md-4 col-sm-4 form-group">
                                <label for="txtPropietario">Propiestario</label>
                                <asp:TextBox ID="txtPropietario" runat="server" CssClass="form-control" Text=""></asp:TextBox>
                            </div>
                            <div class="col-md-4 col-sm-4 form-group">
                                <label for="txtConductor">Conductor</label>
                                <asp:TextBox ID="txtConductor" runat="server" CssClass="form-control" Text=""></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-sm-2 form-group">
                        ...
                        <div id="dtextfiltros" runat="server" class="col-md-12 col-sm-12 no-results text-center">
               ...
               <div class="col-md-12 col-sm-12 pd-l-10 pd-r-10">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gcDatosBuscador" runat="server" 
				            ...
				            <Columns>
                                <asp:TemplateField HeaderText="MATRICULA" ItemStyle-Width="20%" HeaderStyle-Width="20%">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_MATRICULA" runat="server" Text='<%# Bind("MATRICULA")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="PROPIETARIO" ItemStyle-Width="40%" HeaderStyle-Width="40%">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_PROPIETARIO" runat="server" Text='<%# Bind("PROPIETARIO")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="CONDUCTOR" ItemStyle-Width="40%" HeaderStyle-Width="40%">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_CONDUCTOR" runat="server" Text='<%# Bind("CONDUCTOR")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
				            </Columns>
        ...
        <ContentTemplate>															
			...
			<input id="hdnPropietario" style="WIDTH: 8px" type="hidden" name="hdnPropietario" runat="server" />
            <input id="hdnConductor" style="WIDTH: 8px" type="hidden" name="hdnConductor" runat="server" />			        						    						    						    
                
            <asp:HiddenField ID="hdnPrescriptorId" runat="server" />
