<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="portes_listado.aspx.vb" Inherits="TransAmets2.portes_listado" %>
            ...
            <div id="pestanas" style="float: left; z-index: 0;padding-left:0px !important;margin-left:0px !important;">
                ...
                <div class="tab-content">
                            ...
                            <div id="tbl_filters" class="row buscador" style="margin-left:0px !important; margin-right: 0px !important">
                                <div class="col-md-7 col-sm-7 col-xs-7 form-group">
                                    <div class="col-md-4 col-sm-4 col-xs-4 form-group pd-l-0">
                                        <label for="txtFecPorte"><i class="fa fa-calendar"></i> Fecha Porte</label>
                    ...
                    <div role="tabpanel" class="tab-pane" id="Filtros1">
                        <!-- Filtros -->
                        <asp:UpdatePanel runat="server" ID="UP_Filtros_mas" UpdateMode="Conditional">
                            <ContentTemplate>
                            <div id="tbl_filters2" class="row buscador" style="margin-left:0px !important; margin-right: 0px !important">
                                <div class="col-md-5 col-sm-5 col-xs-5 form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-6 form-group pd-l-0">
                                        <label for="txtFecEntrega"><i class="fa fa-calendar"></i> Fecha Entrega</label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-7 form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlEstado" CssClass="form-control selectpicker show-tick" data-width="100%">
                                            ...
                                            <asp:ListItem Selected="True" Value="SF">Sin facturar</asp:ListItem>
                                            <asp:ListItem Value="SP">Sin pagar</asp:ListItem>
                                            <asp:ListItem Value="FSCN">Facturado sin cobrar</asp:ListItem>
                                            <asp:ListItem Value="FSCS">Facturado y cobrado</asp:ListItem>
                                            <asp:ListItem Value="PS">Pagados</asp:ListItem>
                                            <asp:ListItem Value="SFSP">Sin Facturar ni Pagar</asp:ListItem>
                                            <asp:ListItem Value="CSPSP">Cobrado y Pagado</asp:ListItem>
                                        </asp:DropDownList>                                       
                                    </div>
                                </div>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane active pd-l-0 pd-r-0" id="eligible">
                        ...
                        <ContentTemplate>
                            <div id="ELsortOrder" class="col-md-12 col-sm-12 pd-l-0 pd-r-0 ELsortOrder" runat="server">
                                <div class="col-md-3 col-sm-3 text-center ordenacion selected DecisionExpiryDate" data-field="FECHA">Fecha Porte&nbsp;<i class="fa fa-caret-down"></i></div>
	                            <div class="col-md-3 col-sm-3 text-center ordenacion CustomerName" data-field="CODCLI">CLIENTE</div>
	                            <div class="col-md-3 col-sm-3 text-center ordenacion Nombre" data-field="MATRICULA">TRANSPORTISTA</div>
                                <div class="col-md-3 col-sm-3 text-center ordenacion Marca" data-field="ESTADO">ESTADO</div>
                            </div>
                            <!-- Eligible -->
                            <!-- NO REGISTROS -->
                                        ...
                                        <ItemTemplate>
                                            <div class="caja_regs_gridview">
                                                <div class="row border-sup col-md-12 col-sm-12 pd-l-0 pd-r-0" style="margin-left: 0px; background-color: #DDDDDD;">
                                                    <div class="col-md-3 col-sm-3 col-xs-3 pd-l-0">
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-5 form-group datos_listado">
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-5 form-group datos_listado">
                                                            <span style="font-weight:bold"><i class="fa fa-calendar"></i> F. Entrega </span><br />
                                                    ...
                                                    <div class="col-md-3 col-sm-3 col-xs-3 pd-l-0 pd-r-10" style="margin-left:0px !important">
                                                        <div class="col-md-7 col-sm-7 pd-l-0 pd-r-0">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:center; vertical-align:middle; background-color:#808080;"><a style="color:#fff;font-weight:bold" title="Estado Factura">Factura</a></td>
                                                                <td style="width:50%; text-align:center; vertical-align:middle;font-weight:bold"><asp:Label runat="server" id="lblFactura" CssClass="" text=''></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width:50%; text-align:center; vertical-align:middle; background-color:#808080;"><a style="color:#fff;font-weight:bold" title="Estado Pago">Pago</a></td>
                                                                <td style="width:50%; text-align:center; vertical-align:middle;font-weight:bold"><asp:Label runat="server" id="lblPago" CssClass="" text=''></asp:Label></td>
                                                            </tr>
                                                            </table>
                                                        </div>
                                                        <div class="col-md-5 col-sm-5 pd-l-0 pd-r-0" style="text-align:right">            
                                                            <asp:LinkButton ID="btnOpen_Porte" runat="server" CssClass="btn btn-fol btn-fol-forms-grey bt-search-registro hvr-grow-shadow btn-open-delete" data-toggle="tooltip" data-placement="bottom" Text="" ToolTip="Abrir Porte"><span class="fa fa-search" style="margin-top: 13px;"></span></asp:LinkButton>
                                                ...
                                                <div class="row col-md-12 col-sm-12 pd-l-15 pd-r-5" style="margin-left: 0px !important;">
                                                    <table class="tcalertas" border="0" style="width:100% !important;">
                                                        <tr>
                                                            <td style="width:10%; text-wrap:inherit;vertical-align:top;">
                                                                <Label for="lblCompra" style="font-weight:bold"><i class="fa fa-euro-sign"></i> COMPRA</Label><br />
                                                                <asp:Label runat="server" id="lblCompra" text=""></asp:Label>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width:10%; text-wrap:inherit;vertical-align:top;">
                                                                <Label for="lblVenta" style="font-weight:bold"><i class="fa fa-euro-sign"></i> VENTA</Label><br />
                                                                <asp:Label runat="server" id="lblVenta" text=""></asp:Label>
                                                            </td>
                                                            <td style="width:30%; text-wrap:none;vertical-align:top;">
                                                                <label for="lbl_DETALLE" style="font-weight:bold"><i class="fa fa-info-circle"></i> DETALLE</label><br />
                                                                <asp:Label runat="server" id="lbl_DETALLE" text=""></asp:Label>
                                                            </td>
                                                            <td style="width:30%; text-wrap:none;vertical-align:top;">
                                                                <label for="lbl_DESIGNACION" style="font-weight:bold"><i class="fa fa-info-circle"></i> DESIGNACIÓN</label><br />
                                                                <asp:Label runat="server" id="lbl_DESIGNACION" text=""></asp:Label>
                                                            </td>
                                                            <td style="width:30%; text-wrap:none;vertical-align:top;">
                                                                <label for="lbl_INCIDENCIAS" style="font-weight:bold"><i class="fa fa-info-circle"></i> INCIDENCIAS</label><br />
                                                                <asp:Label runat="server" id="lbl_INCIDENCIAS" text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function ReloadDatepicker() {
            ...
            $('#ctl00_MainContent_txtFecPorte').daterangepicker({
                ...
                "cancelClass": "btn-cleantxtFecPorte"
            }, function(start, end, label) {            
                $('#ctl00_MainContent_txtFecPorte').val(start.format('DD/MM/YYYY') + ' - ' + end.format('DD/MM/YYYY'));
            ...
            $('#ctl00_MainContent_txtFecEntrega').daterangepicker({
                ...
                "alwaysShowCalendars": true,
                //"minDate": moment().subtract('month', 60).startOf('month'),
                "cancelClass": "btn-cleantxtFecEntrega"
            }, function (start, end, label) {
                $('#ctl00_MainContent_txtFecEntrega').val(start.format('DD/MM/YYYY') + ' - ' + end.format('DD/MM/YYYY'));
                //console.log("New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')");
                //console.log(this);
            });
            /* Acciones de calendarios para reiniciar los input */
