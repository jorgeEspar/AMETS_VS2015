                            ...
                            <div id="tbl_filters2" class="row buscador" style="margin-left:0px !important; margin-right: 0px !important">
                                <div class="col-md-5 col-sm-5 col-xs-5 form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6 form-group">
                                        <Label class="txtDirCarga"><i class="fa fa-map-marker-alt"></i><i class="fa fa-arrow-right"></i> Dirección de Carga</Label>
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-7 form-group">
                                    <div class="col-md-4 col-sm-4 col-xs-4 form-group pd-l-0">
                                        <label for="txtDestino"><i class="fa fa-arrow-right"></i><i class="fa fa-map-marker-alt"></i> Dirección Destino</label>
