...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="server">
    ...
    <style>
        ...
        #ctl00_MainContent_grFacturas tbody > tr {
                                ...
                                <div id="tbl_filters" class="row buscador" style="margin-left:0px !important; margin-right: 0px !important">
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-2 form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlEstado" CssClass="form-control selectpicker show-tick" data-width="100%">
                                            ...
                                            <asp:ListItem Value="CP">Cobros parciales</asp:ListItem>
                                            <asp:ListItem Value="VS">Vencen esta semana</asp:ListItem>
                                            <asp:ListItem Value="FV">Fuera vencimiento</asp:ListItem>
                                        </asp:DropDownList>                     
                                    </div>
                                </div>
                                </ContentTemplate>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active pd-l-0 pd-r-0" id="eligible">
                        ...
                        <ContentTemplate>
                            ...
                            <!-- TOTALES ============================= -->
                            <div id="divTotales" runat="server" class="col-md-12 col-sm-12 pd-l-0 pd-r-0">
                                <div class="col-md-4 col-sm-4 pd-l-0 pd-r-5">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">TOTAL Facturas</span>
                                            <asp:TextBox runat="server" ID="lblTotalFacturas" CssClass="string NumericField form-control text-right" Font-Bold="true" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                            <span class="input-group-addon"><i class="fa fa-euro-sign"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 text-center pd-l-5 pd-r-5">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">TOTAL cobrado</span>
                                            <asp:TextBox runat="server" ID="lblTotalCobrado" CssClass="string NumericField form-control text-right" Font-Bold="true" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                            <span class="input-group-addon"><i class="fa fa-euro-sign"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 text-right pd-l-5 pd-r-0 mr-0">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">TOTAL Pendiente cobro</span>
                                            <asp:TextBox runat="server" ID="lblTotalPendienteCobro" CssClass="string NumericField form-control text-right" Font-Bold="true" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                            <span class="input-group-addon"><i class="fa fa-euro-sign"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 pd-l-0 pd-r-0">
                                <asp:DataGrid ID="grFacturas" runat="server"
                                ShowHeader="False"
