                                            ...
                                            <asp:UpdatePanel runat="server" ID="UP_Cliente" UpdateMode="Conditional">
                                                ...
                                                <div class="row registro">
                                                    <div class="col-md-5 col-sm-5 col-xs-5 pd-l-0 pd-r-0">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12 pd-l-0 pd-r-0" style="margin-top: 46px">
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12 pd-l-0 pd-r-0" style="margin-top: 5px">
                                                            <Label class="txtCliente"><i class="fa fa-map-marker-alt"></i> Dirección Cliente libre</Label>
                                                            <asp:TextBox ID="txtDircargaLibre" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="5"  maxlength="1500"></asp:TextBox>
                                                        </div>
                                                        
                                                    </div>

                                                    <div id="dirCargaCliente" class="col-md-7 col-sm-7 col-xs-7" style="height: 250px !important; margin-top:15px;">
                                    ...
                                    <div class="panel panel-default" style="width: 100%">
                                        ...
                                        <div class="panel-body" style="display: inline-block; width: 100%; background-color: #fff;">
                                            <div class="row registro pd-l-0 pd-r-0">
                                                <div class="col-md-6 col-sm-6 form-group pd-l-5 pd-r-5 pd-t-10">
                                                    ...
                                                    <div class="row col-md-12 col-sm-12 form-group pd-t-10">
                                                ...
                                                <div class="col-md-6 col-sm-6 form-group pd-t-10">
                                                    <span><i class="fa fa-cube"></i> DETALLE PORTE</span>
                                                    <asp:TextBox ID="txtDetalle" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="11"  placeholder="Indique la mercancia del porte ..." maxlength="1500"></asp:TextBox>
                                        ...
                                        <div class="panel-body" style="display: inline-block; width: 100%; background-color: #fff;">                                           
                                            ...
                                            <div class="row registro pd-l-0 pd-r-0">
                                                ...
                                                <div class="col-md-6 col-sm-6 form-group">
                                                    ...
                                                    <asp:TextBox ID="txtLineasFactura" class="form-control" style="min-width: 100%" runat="server" TextMode="MultiLine" Wrap="true" Rows="6" placeholder="Indique el texto para Factura ..." maxlength="1500"></asp:TextBox>
